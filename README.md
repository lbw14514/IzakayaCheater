...
|---|---|---|---|
| 最终挑战（幽幽子）| `Challenge_Finale_P1` | 无判定，恒可用 | 幽幽子羁绊特殊对话 |
...
| 逮捕蛟龙挑战赛 | `DLC5_RepeatChallenge_ArrestMizuchi_Enter_Event` | finishedEvents：`DLC5_Challenge_ArrestMizuchi_Successful_GoHome_Event` | 月都控制台 |
